...
var styleSwitcher = {
    init: function () {
        ...
        // Style Switcher CSS
        yepnope([
            {load: '../recursos/assets/css/style-switcher.css'},
            {load: '../recursos/assets/lib/colorpicker/css/colorpicker.css'},
            {load: '../recursos/assets/lib/cssbeautify/cssbeautify.js'},
            {load: '../recursos/assets/lib/colorpicker/js/bootstrap-colorpicker.js',
                complete: function () {
                    yepnope([
                        {load: '../recursos/assets/less/theme.less'},
                        {load: '../recursos/assets/lib/less-1.5.0.min.js',
                            complete: function () {
